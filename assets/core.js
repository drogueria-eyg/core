...
window.EYG = (function(){
  ...
  const MODULOS = [
    ...
    {key:"vender",    dept:"comercial", cat:"Comercial", ico:"🛒", titulo:"Cargar venta", desc:"Armá el pedido del cliente desde la tablet: elegí el cliente, cargá productos del catálogo y confirmá. Se guarda solo como presupuesto en Odoo.", roles:["comercial","lider"], ready:true, path:()=>"comercial/vender.html"},
