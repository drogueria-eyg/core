...
window.EYG = (function(){
  ...
  const MODULOS = [
    ...
    {key:"nombres",   dept:"inventario", cat:"Inventario", ico:"🏷️", titulo:"Nombres de productos", desc:"Estandarizá la base: detecta errores en los nombres y sugiere el correcto, con desglose de concentración, presentación y bulto. Un clic para aplicar.", roles:["inventario"], ready:true, path:()=>"inventario/nombres.html"},
